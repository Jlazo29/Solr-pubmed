...
public class TestModel extends Base
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        BufferedReader sentenceFile = new BufferedReader(new FileReader(args[1])); //train.in
        BufferedReader mentionTestFile = new BufferedReader(new FileReader(args[2])); //GENE.eval
        BufferedReader mentionAlternateFile = new BufferedReader(new FileReader(args[3])); //ALTGENE.eval
        File modelFile = new File(args[4]); //model file
        String directory = args[5]; //input directory?
        ...
        CRFTagger tagger = CRFTagger.load(modelFile, properties.getLemmatiser(), properties.getPosTagger(), properties.getPreTagger());
        ...
        double[] results = Base.getResults(mentionsTest, mentionsAlternate, mentionsFound);
