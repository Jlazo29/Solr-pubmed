...
public class StringConf {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "conf-theme", type = ConfTheme.class, required = false),
        ...
        @XmlElementRef(name = "conf-num", type = ConfNum.class, required = false),
        ...
        @XmlElementRef(name = "string-conf", type = StringConf.class, required = false),
