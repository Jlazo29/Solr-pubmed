 ...
 *         &lt;/choice>
 *         &lt;element ref="{}nested-kwd" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "nested-kwd")
public class NestedKwd {
    ...
    @XmlElement(name = "nested-kwd")
    protected List<NestedKwd> nestedKwd;
    ...
    /**
     * Gets the value of the nestedKwd property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the nestedKwd property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNestedKwd().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<NestedKwd> getNestedKwd() {
        if (nestedKwd == null) {
            nestedKwd = new ArrayList<NestedKwd>();
        }
        return this.nestedKwd;
    }
